...
- **Probe fabrication vendor/service**: [Fabrication process](https://www.fabublox.com/process-editor/899ce03e-38a6-4836-bd59-ae51e0551a5e)
- **PCB fabrication**: Standard PCB manufacturers (OSHPark, PCBWay, JLC PCB, etc.) — see `pcb/README.md` for Gerber files.
- **3D-printed adapter**: Formlabs Form 3 with clear resin
