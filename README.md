...
- Fabrication process (detailed steps and external resources) are in `fabrication/README.md`. For the fabrication service used in this work, see: [Probe fabrication process & vendor link]((https://www.fabublox.com/process-editor/899ce03e-38a6-4836-bd59-ae51e0551a5e)]) (replace with actual link when available).
